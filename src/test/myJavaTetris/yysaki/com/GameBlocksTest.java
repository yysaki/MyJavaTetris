...
public class GameBlocksTest extends ProjectTests {
	...
	public void testGetColor() {
		GameBlocks b1 = new GameBlocks(new Point(), 0);
		GameBlocks b2 = new GameBlocks(new Point(1,2), 0, 1);
	...
	public void testGetPoints() {
		GameBlocks b1 = new GameBlocks(new Point(), 0, 1);
	...
	public void testGetDir() {
		...
		GameBlocks b1 = new GameBlocks(new Point(1,1), 0, 1);
		GameBlocks b2 = new GameBlocks(b1);
		GameBlocks b3 = new GameBlocks(new Point(100,100), 10, 1);
	...
	public void testGetRotate() {
		GameBlocks b1 = new GameBlocks(new Point(), 0, 1);
		GameBlocks b2 = new GameBlocks(b1);
		GameBlocks b3 = new GameBlocks(new Point(), 10, 1);
	...
	public void testSetRotate() {
		GameBlocks b = new GameBlocks(new Point(), 0, 1);
